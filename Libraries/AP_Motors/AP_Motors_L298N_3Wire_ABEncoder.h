#ifndef __AP_MOTORS_L298N_3WIRE_ABENCODER_H__
#define __AP_MOTORS_L298N_3WIRE_ABENCODER_H__

#include "AP_Motors_Backend.h"

#define MOTORS_L298N_3WIRE_ABENCODER_VCOM_DEBUG      0

class AP_Motors_L298N_3Wire_ABEncoder : public AP_Motors_Backend
{
public:
  AP_Motors_L298N_3Wire_ABEncoder(AP_Motors          &instance,
...
#endif /* __AP_MOTORS_L298N_3WIRE_ABENCODER_H__ */
