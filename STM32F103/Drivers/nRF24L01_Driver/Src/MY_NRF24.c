...
//CE and CSN pins
#if !defined(nrf_CSN_PORT) && !defined(nrf_CSN_PORT)
...
void NRF24_csn(int state)
{
  ...
  if(state) HAL_GPIO_WritePin(nrf_CSN_PORT, nrf24_CSN_PIN, GPIO_PIN_SET);
  else HAL_GPIO_WritePin(nrf_CSN_PORT, nrf24_CSN_PIN, GPIO_PIN_RESET);
#else
...
void NRF24_ce(int state)
{
  ...
  if(state) HAL_GPIO_WritePin(nrf_CE_PORT, nrf24_CE_PIN, GPIO_PIN_SET);
  else HAL_GPIO_WritePin(nrf_CE_PORT, nrf24_CE_PIN, GPIO_PIN_RESET);
#else
